...
Vector3f SensorImpl::update()
{
    ...
    switch (m_sensor)
    {
        case Sensor::Accelerometer:
            ...
            value.x = static_cast<float>(manager.accelerometerData.acceleration.x) * 9.81f;
            value.y = static_cast<float>(manager.accelerometerData.acceleration.y) * 9.81f;
            value.z = static_cast<float>(manager.accelerometerData.acceleration.z) * 9.81f;
            break;
        ...
        case Sensor::UserAcceleration:
            ...
            value.x = static_cast<float>(manager.deviceMotion.userAcceleration.x) * 9.81f;
            value.y = static_cast<float>(manager.deviceMotion.userAcceleration.y) * 9.81f;
            value.z = static_cast<float>(manager.deviceMotion.userAcceleration.z) * 9.81f;
            break;
