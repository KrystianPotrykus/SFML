...
m_manager(0)
{
    ...
    m_layoutData = static_cast<CFDataRef>(TISGetInputSourceProperty(tis,
    ...
    m_layout = static_cast<UCKeyboardLayout*>(static_cast<void*>(const_cast<UInt8*>(CFDataGetBytePtr(m_layoutData))));
...
void HIDInputManager::initializeKeyboard()
{
    ...
    {
        IOHIDDeviceRef keyboard = static_cast<IOHIDDeviceRef>(const_cast<void*>(devicesArray[static_cast<size_t>(i)]));
